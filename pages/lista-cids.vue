...
<template>
  ...
  >
    ...
    <ul class="filters">
      ...
      <v-dialog v-model="dialog" class="v-dialog" content-class="accessibility-dialog" max-width="80vw">
        <v-card>
          <v-card-title class="headline" />
          <v-card-text>
            <div class="dialog-container">
...
.container.high-contrast :deep(.v-data-table),
.container.high-contrast :deep(.v-card),
.container.high-contrast :deep(.v-input__slot),
.container.high-contrast :deep(.v-btn) {
  border: 1px solid var(--border-color) !important;
}

:deep(.accessibility-dialog) {
  font-size: calc(1rem * var(--font-scale)) !important;
}
